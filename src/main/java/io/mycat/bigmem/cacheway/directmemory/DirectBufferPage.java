package io.mycat.bigmem.cacheway.directmemory;
...
public class DirectBufferPage {
    ...
    */
    ...
    public DirectBufferPage(ByteBuffer buffer, int chunkSize) {
        this.buffer = buffer;
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        DirectBufferPage page = new DirectBufferPage(buffer, 256);
        ...
        // 获得内存buffer
        sun.nio.ch.DirectBuffer thisNavBuf = (sun.nio.ch.DirectBuffer) bufferItem2;
